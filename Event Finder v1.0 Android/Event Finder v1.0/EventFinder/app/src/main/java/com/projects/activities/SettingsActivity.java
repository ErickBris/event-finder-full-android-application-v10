...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        String val = String.valueOf(Config.DEFAULT_FILTER_DISTANCE_IN_KM);
        if(distance > 0) {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if(preference.getKey().compareTo("notifications_radius") == 0) {
                    ...
                    preference.setTitle(R.string.radius_nearby);
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        String val = PreferenceManager
                ...
                .getString(preference.getKey(), String.valueOf(Config.DEFAULT_FILTER_DISTANCE_IN_KM));
