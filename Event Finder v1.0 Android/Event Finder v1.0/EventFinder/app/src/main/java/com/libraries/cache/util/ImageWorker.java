...
public abstract class ImageWorker {
    ...
    public void loadImageWithRadiusAndColor(Object data, ImageView imageView, int radius, int color) {
    	if (data == null) {
            return;
        }
    	...
    	BORDER_THICKNESS = -1;
    	COLOR = color;
    	loadImageCustom(data, imageView);
    	
    }
    
    public void loadImageWithRadius(Object data, ImageView imageView, int radius) 
    {
    	if (data == null) {
            return;
        }
    ...
    public void loadImageWithFrame(Object data, ImageView imageView, int thumbThickness) 
    {
        ...
        BORDER_RADIUS = -1;
        BORDER_THICKNESS = thumbThickness;
        COLOR = -1;
        loadImageCustom(data, imageView);
    }
...
//                Log.e("BORDER RADIUS", ""+BORDER_RADIUS);
