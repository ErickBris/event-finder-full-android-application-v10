...
public class FeaturedFragment extends Fragment implements GlobalApplication.OnLocationListener{
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		app.sendScreenView(Config.kGAIScreenNameFeatured);
	}
				...
				if(GlobalApplication.currentLocation!= null) {
					try {
						...
						String strUrl = String.format("%s?api_key=%s&lat=%s&lon=%s&radius=%s",
								Config.GET_FEATURED_EVENTS_JSON_URL,
								Config.API_KEY,
