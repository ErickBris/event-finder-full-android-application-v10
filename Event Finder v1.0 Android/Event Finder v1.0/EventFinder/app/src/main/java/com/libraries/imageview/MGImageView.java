...
public class MGImageView extends ImageView {
  ...
  public MGImageView(Context context) {
    super(context);
  }

  public MGImageView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public MGImageView(Context context, AttributeSet attrs, int defStyle) {
